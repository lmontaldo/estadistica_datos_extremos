...
Se define la distribución GEV de posición \(\mu\), escala \(\beta\) e
índice \(\xi\) a

El caso ξ=0 corresponde a Gumbel, el caso ξ\textless0 a Weibull y α=-1/
ξ, el caso ξ\textgreater0 a Fréchet y α=1/ ξ En R existen rutinas para
estimar ξ con intervalos de confianza (por máxima verosimilitud, etc.)
lo cual da formas de testear si una extremal es Gumbel, Weibull o
Fréchet.
