...
\NormalTok{df }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{relacion =} \FunctionTok{lag}\NormalTok{(Close) }\SpecialCharTok{/}\NormalTok{ Close)}
...
\NormalTok{df}\SpecialCharTok{$}\NormalTok{indicador}\OtherTok{=}\NormalTok{df}\SpecialCharTok{$}\NormalTok{relacion}\DecValTok{{-}1}
\end{Highlighting}
\end{Shaded}
...
En (\citeproc{ref-notas}{\textbf{notas?}}) se señala la importancia del
