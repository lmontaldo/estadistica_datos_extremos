...
\texttt{\{\{r\ eval=FALSE,\ include=FALSE\}\ library(patchwork)\ if\ (!require(patchwork))\ \{\ \ \ \ \ install.packages("patchwork")\ \}\ library(evd)\ if\ (!require(evd))\ \{\ \ \ \ \ install.packages("evd")\ \}\ if\ (!require(lubridate))\ \{\ \ \ \ \ install.packages("lubridate")\ \}\ library(lubridate)\ if\ (!require(dplyr))\ \{\ \ \ \ \ install.packages("dplyr")\ \}\ library(dplyr)\ if\ (!require(ggplot2))\ \{\ \ \ \ \ install.packages("ggplot2")\ \}\ library(ggplot2)\ if\ (!require(urca))\ \{\ \ \ \ \ install.packages("urca")\ \}\ library(tseries)\ if\ (!require(tseries))\ \{\ \ \ \ \ install.packages(tseries)\ \}}
\newpage
