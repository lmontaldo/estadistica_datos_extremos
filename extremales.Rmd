...
ggplot(df, aes(x = Date, y = Close)) +
  geom_line() +
  ggtitle("S&P 500: valores diarios históricos al cierre (03/01/1928-08/12/2023)") +
  xlab("fecha") +
...
ggplot(df, aes(x = Date, y = relacion)) +
  geom_line() +
  ggtitle("S&P500: valores históricos del Indicar (03/01/1928-08/12/2023)") +
  xlab("fecha") +
...
Siguiendo \cite{notas_curso} se dice que tenemos datos extremos cuando cada
